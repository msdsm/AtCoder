...
/*
		...
		cout << i << endl;
		cout << dp[i][v.size()-1] << endl;
		cout << (dp[i][v.size()-1]<=t) << endl;
		cout << ((i&(1<<0))==1) << endl;
		cout << ((1<<(v.size()-1))) << endl;
		cout << ((i&(1<<(v.size()-1)))==1) << endl;
		cout << "debug before if end" << endl;
*/		
		
		if((dp[i][v.size()-1]<=t) && ((i&(1<<0))>0) && ((i&(1<<(v.size()-1)))>0)){
			/*
			cout << "debug after if" << endl;
			cout << i << endl;
			cout << "debug after if end" << endl;
			*/
			
			if(ans<__builtin_popcount(i)-2)
